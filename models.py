# -*- coding: utf-8 -*-
"""
Modelos SQLAlchemy para Tarea 2 + Tarea 3.
Tarea 3 agrega el modelo Comentario, que referencia a Actividad.
"""
...
class Comuna(db.Model):
    ...
    miembros = db.relationship('Miembro', backref='comuna', lazy='dynamic')
...
# ---------------------------------------------------------------------------
# TAREA 3: Modelo Comentario (corresponde a tabla-comentario.sql)
# ---------------------------------------------------------------------------
class Comentario(db.Model):
    ...
    texto        = db.Column(db.String(300), nullable=False)  # cuerpo del comentario
    fecha        = db.Column(db.DateTime, nullable=False, default=datetime.now)
    actividad_id = db.Column(db.Integer, db.ForeignKey('actividad.id'), nullable=False)

    def __repr__(self):
        return '<Comentario {}: {}>'.format(self.id, self.nombre)
